<template>
    <div class="menu">
        ...
        <a v-if="type == 'passenger'" v-link="{path : '/passenger/passengerRelease'}" :class="{'hover' : $route.name =='passengerRelease'}">发布行程</a>
        <a v-if="type == 'passenger'" v-link="{path : '/passenger/passengerSearch'}" :class="{'hover' : $route.name =='passengerSearch'}">搜索行程</a>

        <a v-if="type == 'driver'" v-link="{path : '/driver/driverRelease'}" :class="{'hover' : $route.name =='driverRelease'}">发布行程</a>
        <a v-if="type == 'driver'" v-link="{path : '/driver/driverSearch'}" :class="{'hover' : $route.name =='driverSearch'}">搜索行程</a>
...
////                            this.$router.go("/account/carInfo");
////                            layer.close();
////                        });
////                    }else{
